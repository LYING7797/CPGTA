...
Data Required
Before using the CPGTA package, the necessary data will be automatically downloaded during the installation process. The data will be stored in the CPGTA folder within your project directory.
