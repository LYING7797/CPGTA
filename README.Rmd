...
From Zenodo (Recommended): Download the data from our Zenodo repository (DOI: 10.5281/zenodo.17357650)
        
After downloading, place all the data in the installation directory of the CPGTA package. The typical location would be within your R library path where the CPGTA package is installed.
