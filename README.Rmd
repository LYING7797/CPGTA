...
cptod()
This function is used to obtain cancer multi-omics data from the data directory.
...
The function reads counts data from tumor and normal samples based on PDC codes, performs differential expression analysis
